...
console.log("[dashboard.js] Script cargado en:", window.location.href);
console.log(
    "[dashboard.js] API URL:",
    import.meta.env ? import.meta.env.PUBLIC_API_URL : "Variable no disponible"
);
